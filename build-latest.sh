...
cd temp-package
../ZXPSignCmd -sign . ../dist/AirBoard-v4.9.1.zxp ../new-cert.p12 mypassword
...
if [ -f "dist/AirBoard-v4.9.1.zxp" ]; then
    echo "✅ SUCCESS: ZXP created at dist/AirBoard-v4.9.1.zxp"
    ls -la dist/AirBoard-v4.9.1.zxp
else
