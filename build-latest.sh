...
cd temp-package
../ZXPSignCmd -sign . ../dist/AirBoard-v3.9.5.zxp ../new-cert.p12 mypassword
...
if [ -f "dist/AirBoard-v3.9.5.zxp" ]; then
    echo "✅ SUCCESS: ZXP created at dist/AirBoard-v3.9.5.zxp"
    ls -la dist/AirBoard-v3.9.5.zxp
else
