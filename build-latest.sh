...
cd temp-package
../ZXPSignCmd -sign . ../dist/AirBoard-v2.4.9.zxp ../new-cert.p12 mypassword
...
if [ -f "dist/AirBoard-v2.4.9.zxp" ]; then
    echo "✅ SUCCESS: ZXP created at dist/AirBoard-v2.4.9.zxp"
    ls -la dist/AirBoard-v2.4.9.zxp
else
