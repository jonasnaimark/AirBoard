...
function applySquircle() {
    ...
    var ffxPath = extensionRoot + "/presets/SquircleComplete.ffx";
    var ffxFile = new File(ffxPath);
    
    // Check if file exists with alternate separator
    if (!ffxFile.exists) {
        ffxPath = extensionRoot + "\\presets\\SquircleComplete.ffx";
    ...
    if (!ffxFile.exists) {
        ...
        ffxPath = extRoot.fsName + "/presets/SquircleComplete.ffx";
        ffxFile = new File(ffxPath);
    }
