...
- **Multi-Layer Shadows**: Add Shadow now applies to ALL selected layers instead of just the first one
  - Select multiple layers and apply elevation shadows in one click
  - Solid layers are automatically skipped (won't block other layers from receiving shadows)

### 🔗 Associated Build
- AirBoard-v4.17.11.zxp
